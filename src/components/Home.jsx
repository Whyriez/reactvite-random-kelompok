...
function Home() {
  ...
  return (
    <div>
      <div className="lg:flex xl-flex sm:block space-x-6">
        <div className="grid grid-cols-1 gap-4 lg:flex">
          ...
          {/* Start Controller */}
          <div className="block lg:w-[40rem] md:mx-auto sm:w-[37rem] min-h-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800  ">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Controller
            </h5>
          ...
          {/* Start Results */}
          <div className="lg:w-full lg:mx-auto md:w-[37rem] h-[35rem] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800  ">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Results
            </h5>
            <div
